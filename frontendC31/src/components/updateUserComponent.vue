            ...
            <b-form novalidate @submit.prevent="onSubmit" class="p-4">
                <div class="row">
                    <b-form-group class="col-md-6 col" id="nombres-input-group" label="Nombres" label-for="nombres-input">
                        <b-form-input id="nombres-input" name="nombres-input" v-model="$v.form.nombres.$model" :state="validateState('nombres')" aria-describedby="nombres-input-live-feedback">{{usuario.nombres}}</b-form-input>
